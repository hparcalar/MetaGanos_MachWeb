...
const makeUpload = async () => {
  try {
    ...
    const postResult = await api.post('Item/Upload', formData)
            ...
            <div class="tab-content is-active mt-5">
              <div class="flex-table is-rounded">
                ...
                >
                  ...
                  ><span class="cell-center transfer-template-heading">Kategorisi</span
                  ><span class="cell-center transfer-template-heading">Grubu</span>
                  <span class="cell-center transfer-template-heading">Barkod</span>
                  <span class="cell-center transfer-template-heading">Birim</span>
                </div>
              </div>
