...
const bindModel = async () => {
  try {
    ...
    const data = await api.get('Dealer/' + modelObject.value.id)
...
const saveModel = async () => {
  try {
    const postResult = await api.post('Dealer', modelObject.value)
              ...
              <div class="columns is-multiline">
                <div class="column is-6">
                  <VField>
                    ...
                    <VControl icon="feather:terminal">
                      <input
                        v-model="modelObject.dealerCode"
                        type="text"
                        class="input"
                        placeholder=""
                        autocomplete="off"
                ...
                <div class="column is-6">
                  <VField>
                    ...
                    <VControl icon="feather:terminal">
                      <input
                        v-model="modelObject.dealerName"
                        type="text"
                        class="input"
                        placeholder=""
                        autocomplete="off"
                ...
                <div class="column is-6">
                  <VField>
                    ...
                    <VControl icon="feather:terminal">
                      <input
                        v-model="modelObject.dealerPassword"
                        type="password"
                        class="input"
                        placeholder=""
                        autocomplete="off"
              ...
              <div class="columns is-multiline">
                <div class="column is-12">
                  <VField>
                    ...
                    <VControl icon="feather:terminal">
                      <input
                        v-model="modelObject.licenseKey"
                        type="text"
                        class="input"
                        placeholder=""
                        autocomplete="off"
